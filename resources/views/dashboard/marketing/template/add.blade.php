    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h1 class="card-title mb-0">Add Template</h1>
            </div>
            <div class="card-body">
                <div class="row">
                    <form method="POST" action="{{ url('/marketing/templates/store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label for="Name" class="form-label">Subject</label>
                                <input required type="text" class="form-control" name="subject" placeholder="Email Subject">
                            </div>

                            <div class="col-md-12 form-group mb-3">
                                <label for="Description" class="form-label">Body</label>
                                <textarea name="email_body" class="form-control nicEdit"  rows="10" placeholder="Email Body"></textarea>
                            </div>
