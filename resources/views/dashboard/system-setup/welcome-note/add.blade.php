    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h1 class="card-title mb-0">Add Note</h1>
            </div>
            <div class="card-body">
                <div class="row">
                    <form method="POST" action="{{ url('/system-setup/welcome-note/store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12 form-group mb-3">
                                <label for="Description" class="form-label">Note</label>
                                <textarea name="note" class="form-control"  rows="5" placeholder="Please write the text here."></textarea>
                            </div>
