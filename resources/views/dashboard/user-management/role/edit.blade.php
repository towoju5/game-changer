    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h1 class="card-title mb-0">Edit Role</h1>
            </div>
            <div class="card-body">
                <div class="row">
                    <form method="POST" action="{{ url('/role/update/'.encrypt($role->id)) }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label for="Name" class="form-label">Name</label>
                                <input required type="text" class="form-control" name="name" value="{{ $role->name }}" placeholder="Manager">
                            </div>
                            ...
                            <div class="col-md-12 form-group mb-3">
                                ...
                                <textarea required class="form-control" name="description" rows="2" placeholder="This role is for Managers.">{{ $role->description }}</textarea>
                            </div>
